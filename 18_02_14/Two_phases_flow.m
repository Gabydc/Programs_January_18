...
wtarget  = [P * pu{1}, P * pu{1}, P * pu{1}, P * pu{1}, P * pu{2}];
...
if save_res
    if(training)
       ...
       % saveits_pp_lay(dir1,filetx,use_ICCG,use_DICCG,use_POD,dpod,k,dv,preport,last,'ex', [])
        if window
            if model_SPE
                saveits_pp_spe(dir1,filetx,use_ICCG,use_DICCG,use_POD,dpod,k,dv,preport,last)
            else
                saveits_pp_lay(dir1,filetx,use_ICCG,use_DICCG,use_POD,dpod,k,dv,preport,last,'per', per)
            end
        else
            if model_SPE
