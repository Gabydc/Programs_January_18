classdef ICCGSolverAD < LinearSolverAD
...
along with MRST.  If not, see <http://www.gnu.org/licenses/>.
    ...
    methods
        function solver = ICCGSolverAD(varargin)
...
%             'wells',solver.W,'Iter_m', true,'Amatrix_eigs', true, ...
%             'MAmatrix_eigs',true,'A_cn',true);

                    [result,flag,relres,iter,resvec] = ICCG_MRST(A,b,...
                solver.tolerance,min(solver.maxIterations,nel),L,L',solver.x0,...
           'Iter_m', true,'Residual',false,'A_cn',false,'x_true', false,...
           'Amatrix_eigs', false,'dir',solver.dir);
