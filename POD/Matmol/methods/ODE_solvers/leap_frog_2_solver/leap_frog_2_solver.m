     function [tout, xout] = leap_frog_2_solver(odefunction, t0, tf, x0, xm1, Dt, Dtplot)
%... The Matmol group (2016)
%...
%... leap_frog_2_solver.m solves second-order differential equations using the leap frog method.
%... [tout, xout] = leap_frog_2_solver('f',t0,tf,x0,xm1,Dt,Dtplot) integrates the system  
%... of differential equations xtt = f(t,x) from t0 to tf with initial conditions x0 and xm1.  
...
%...
            xnew = 2*x - xold + (Dt^2)*feval(odefunction, t, x);
            t = t + Dt;
            xold = x;
            x = xnew;
        end
