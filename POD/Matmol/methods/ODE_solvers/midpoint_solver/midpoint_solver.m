     function [tout, xout] = midpoint_solver(odefunction, t0, tf, x0, Dt, Dtplot)
%... The Matmol group (2016)
%...
%... this function solves first-order differential equations using 
%... the midpoint method
%... [tout, xout] = midpoint_solver(@f,t0, tf, x0, Dt, Dtplot) 
...
%...
%...        Euler predictor
            f1 = feval(odefunction, t, x)*Dt/2;
            x12 = x + f1;
%...        Corrector            
            t = t + Dt;
            f2 = feval(odefunction, t, x12)*Dt;
            x = x + f2;
         end
%...    
