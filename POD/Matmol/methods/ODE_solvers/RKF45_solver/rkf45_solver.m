%... The Matmol group (2016)
    function [tout,xout,eout]=rkf45_solver(odefunction,t0,tf,x0, hmin,nstepsmax,abstol,reltol,Dtplot)
%... rkf45_solver solves first-order differential equations using the 
%... Runga-Kutta-Felhberg (4,5) method
%... [tout, xout] = rkf45_solver(@f,t0,tf,x0,hmin,nstepsmax,abstol,reltol,Dtplot) 
...
%... in column vector t.
%...
%... rkf45_solver.m solves first-order differential equations using 
