%...  The Matmol group (2016)
    function out = integrand3_hermite(xi)
%...    
%... Computation of the third integrand on the nonlinear term for the
%... Burgers' equation. This term correspond with 
%...      y3 = phi_3*(xfem*xfem_z)
...
%... Preallocation of memmory for the output
    ...
    for i = 1:length(xi)
        ...
        out(3:2:2*n-1,i) = phi3*(xfem.*xfem_z);
    end
