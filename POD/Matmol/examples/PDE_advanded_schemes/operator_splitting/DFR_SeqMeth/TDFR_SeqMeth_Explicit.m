%... The MatMol Group (2016)									
     function TDFR_SeqMeth_Explicit(Pe,n0,zswitch,orderD2,sequence,Reltol,Abstol)
...
%...                   explicit integrator ode45 for the reaction part
%
...
%... Process
    ...
    E		=  11250;               %... [cal/mol] activation energy
    ...
    switch sequence
        case 'CRD'
            ...
            %... Reaction
                ...
                sol           = ode45(@ODE_SM,[0:dt:dt],IC,options);
...
%... Plot figures
    ...
    end %... End of function TDFR_SeqMeth_Explicit
