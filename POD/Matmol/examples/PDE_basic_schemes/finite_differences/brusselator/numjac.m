...
%   FAC to []. Do not alter the returned value between calls. Use ODESET to
%   set the ODE solver Vectorized property to 'on' if the ODE function 
%   has been coded so that F(t,[y1 y2 ...]) returns [F(t,y1) F(t,y2) ...]. 
...
%   $Revision: 1.32 $  $Date: 2000/06/02 00:11:25 $
