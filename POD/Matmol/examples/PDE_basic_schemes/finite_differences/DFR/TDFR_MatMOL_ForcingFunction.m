%... The MatMol Group (2016)
    function TDFR_MatMOL_ForcingFunction(Pe,n0,zswitch,orderD1,orderD2,...
                                         Reltol,Abstol,tau0)
...
%...                   tau0:     Time constant of the forcing function
...
%... 2c Solution of the DAEs
    ...
    sol = ode45(@ODE_MatMOL_Explicit,[t_start t_end],IC',options);
...
%... As an explicit integrator is used
    Stats.npds   = 0;
    Stats.ndecomps=0;
    Stats.nsolves =0;
    Stats.n       =n;
...
%... 3 Plot results
    ...
    title(['Temperature evolution (MatMOL Explicit: z1=' num2str(z1) ...
    ...
    title(['Concentration evolution (MatMOL Explicit: z1=' num2str(z1) ...
            ' m, Pe1=' num2str(Pe1) ', Pe2=' num2str(Pe2) ', n=' num2str(n) ')'],...
            'Fontsize',20)
    ...
    title(['MatMOL Explicit: z1=' num2str(z1) ' m, Pe1=Pe2=' num2str(Pe2)  ...
    ...
    end %... End of function TDFR_MatMOL_ForcingFunction
%... *************************************************************************




    function dX = ODE_MatMOL_Explicit(t,X)
%... Provide the right hand side of the ODEs with a forcing function for the
...
%... Danckwerts BC at reactor inlet
    Tt(1) = -1/tau*(-D1*Dz(1,:)*T + v*(T(1)-Tin));
    Ct(1) = -1/tau*(-D2*Dz(1,:)*C + v*(C(1)-Cin));

    dX	= [Tt;Ct];
    end %... End of function ODE_MatMOL_Explicit