%... The MatMol Group (2016)
    function TFBBR_MatMOL_ForcingFunction(Pe,n0,orderD1,orderD2,...
                                          Reltol,Abstol,tau0)
...
%... 3 Plot results
    ...
    end %... End of function TFBBR_MatMOL_ForcingFunction

    

    function dX = ODE_MatMOL_Explicit(t,Y)
...
%... Danckwerts BC at reactor inlet
    St(1) = -1/tau*(-D1*Dz(1,:)*S + v*(S(1)-Sin));
