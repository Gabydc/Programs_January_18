...
%   computes the POD basis functions and their associated eigenvalues. 
%
%   Input variables:
%   V:    Set of simulation or experimental data. Each column corresponds
%         with a snapshot at a given time
%   MM:   Mass matrix obtained from the FEM. The FEM discretization must
%         coincide with the discretization for V
%   mth:  Method used for computing the basis functions. 'd' is the direct 
%         method, 'i' is the indirect method. The indirect method results more
%         efficient if the number of discretization points is much larger than
