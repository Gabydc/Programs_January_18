       function [D,z] = periodic_spectral_D2(z0,zL,n)
%...
%...  The MatMol Group (2009)
%...
%...  function periodic_spectral_D2 returns the differentiation matrix for computing 
%...  the second derivative, x_zz, of a variable x over the spatial domain [0,2pi)
...
%...  discretization matrix      
       column = [-pi^2/(3*dz^2)-1/6 0.5*(-1).^(1:n-1).*csc((1:n-1)*dz/2).^2]';
