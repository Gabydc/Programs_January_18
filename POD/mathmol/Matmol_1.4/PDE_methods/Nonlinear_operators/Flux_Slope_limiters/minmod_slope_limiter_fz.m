      function [fz]=minmod_slope_limiter_fz(z,n,t,x,flux,dflux_dx)
%...
%...  The MatMol Group (2009)
%...
%...  function minmod_slope_limiter returns the first derivative, fz, of a 
%...  flux function f(x) over the spatial domain z0 < z < zL from minmod 
...
%...  limited by the slope limiter phi given in the minmod case by
%...
%...  phi = max(0, min(1, r))
%...
