       function [tout, xout, eout] = ros23p_solver(odefunction,jacobian,t0,tf,x0,hmin,nstepsmax,abstol,reltol,Dtplot)
%...
%...  The MatMol Group (2009)
%...
%...   [tout, yout] = ros23p_solver('f','J',t0,tf,x0,hmin,nstepsmax,abstol,reltol,Dtplot) integrates  
%...   the system of differential equations y'=f(t,x) from t0 to tf with initial conditions x0.  
...
%...
%...     Single ros23p step
         [t,x,e] = ssros23p(odefunction,jacobian,t0,x0,h,gamma,a21,a31,a32,c21,c31,c32,alpha,m,mc);
%...
